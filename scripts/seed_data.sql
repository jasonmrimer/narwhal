...
INSERT INTO mission VALUES
  ('1', 'XXX-FAKE-MISSION-1', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 1, 'U-2'),
  ('2', 'XXX-FAKE-MISSION-2', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 2, 'U-2'),
  ('3', 'XXX-FAKE-MISSION-3', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 3, 'U-2'),
  ('4', 'XXX-FAKE-MISSION-4', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 4, 'U-2'),
  ('5', 'XXX-FAKE-MISSION-5', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 5, 'U-2'),
  ('6', 'XXX-FAKE-MISSION-6', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 6, 'U-2'),
  ('7', 'XXX-FAKE-MISSION-7', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 7, 'U-2'),
  ('8', 'YYY-FAKE-MISSION-1', NOW() + INTERVAL 48 HOUR, NOW() + INTERVAL 48 HOUR, 1, 8, 'U-2'),
  ('9', 'YYY-FAKE-MISSION-2', NOW() + INTERVAL 48 HOUR, NOW() + INTERVAL 48 HOUR, 1, 9, 'U-2'),
  ('10', 'YYY-FAKE-MISSION-3', NOW() + INTERVAL 48 HOUR, NOW() + INTERVAL 48 HOUR, 1, 10, 'U-2'),
  ('11', 'ZZZ-FAKE-MISSION-1', NOW() + INTERVAL 96 HOUR, NOW() + INTERVAL 96 HOUR, 2, 11, 'Global Hawk'),
  ('12', 'ZZZ-FAKE-MISSION-2', NOW() + INTERVAL 96 HOUR, NOW() + INTERVAL 96 HOUR, 2, 12, 'Global Hawk'),
  ('13', 'ZZZ-FAKE-MISSION-3', NOW() + INTERVAL 96 HOUR, NOW() + INTERVAL 96 HOUR, 2, 13, 'Global Hawk'),
  ('14', 'AAA-FAKE-MISSION-1', NOW() + INTERVAL 8 DAY, NOW() + INTERVAL 8 DAY, 2, 14, 'Global Hawk'),
  ('15', 'AAA-FAKE-MISSION-2', NOW() + INTERVAL 8 DAY, NOW() + INTERVAL 8 DAY, 2, 15, 'Global Hawk'),
  ('16', 'AAA-FAKE-MISSION-3', NOW() + INTERVAL 8 DAY, NOW() + INTERVAL 8 DAY, 2, 16, 'Global Hawk'),
  ('17', 'BBB-FAKE-MISSION-1', NOW() + INTERVAL 20 DAY, NOW() + INTERVAL 20 DAY, 2, 17, 'Global Hawk'),
  ('18', 'BBB-FAKE-MISSION-2', NOW() + INTERVAL 20 DAY, NOW() + INTERVAL 20 DAY, 2, 18, 'Global Hawk'),
  ('19', 'BBB-FAKE-MISSION-3', NOW() + INTERVAL 20 DAY, NOW() + INTERVAL 20 DAY, 2, 19, 'Global Hawk');
