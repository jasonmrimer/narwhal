...
INSERT INTO mission VALUES
  ('1', 'XXX-FAKE-MISSION-1', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 1),
  ('2', 'XXX-FAKE-MISSION-2', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 2),
  ('3', 'XXX-FAKE-MISSION-3', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 3),
  ('4', 'XXX-FAKE-MISSION-4', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 4),
  ('5', 'XXX-FAKE-MISSION-5', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 5),
  ('6', 'XXX-FAKE-MISSION-6', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 6),
  ('7', 'XXX-FAKE-MISSION-7', NOW() + INTERVAL 6 HOUR, NOW() + INTERVAL 6 HOUR, 1, 7),
  ('8', 'YYY-FAKE-MISSION-1', NOW() + INTERVAL 48 HOUR, NOW() + INTERVAL 48 HOUR, 1, 8),
  ('9', 'YYY-FAKE-MISSION-2', NOW() + INTERVAL 48 HOUR, NOW() + INTERVAL 48 HOUR, 1, 9),
  ('10', 'YYY-FAKE-MISSION-3', NOW() + INTERVAL 48 HOUR, NOW() + INTERVAL 48 HOUR, 1, 10),
  ('11', 'ZZZ-FAKE-MISSION-1', NOW() + INTERVAL 96 HOUR, NOW() + INTERVAL 96 HOUR, 2, 11),
  ('12', 'ZZZ-FAKE-MISSION-2', NOW() + INTERVAL 96 HOUR, NOW() + INTERVAL 96 HOUR, 2, 12),
  ('13', 'ZZZ-FAKE-MISSION-3', NOW() + INTERVAL 96 HOUR, NOW() + INTERVAL 96 HOUR, 2, 13),
  ('14', 'AAA-FAKE-MISSION-1', NOW() + INTERVAL 8 DAY, NOW() + INTERVAL 8 DAY, 2, 14),
  ('15', 'AAA-FAKE-MISSION-2', NOW() + INTERVAL 8 DAY, NOW() + INTERVAL 8 DAY, 2, 15),
  ('16', 'AAA-FAKE-MISSION-3', NOW() + INTERVAL 8 DAY, NOW() + INTERVAL 8 DAY, 2, 16),
  ('17', 'BBB-FAKE-MISSION-1', NOW() + INTERVAL 20 DAY, NOW() + INTERVAL 20 DAY, 2, 17),
  ('18', 'BBB-FAKE-MISSION-2', NOW() + INTERVAL 20 DAY, NOW() + INTERVAL 20 DAY, 2, 18),
  ('19', 'BBB-FAKE-MISSION-3', NOW() + INTERVAL 20 DAY, NOW() + INTERVAL 20 DAY, 2, 19);
