...
INSERT INTO airman VALUES
  ...
  (4, 'Katy', 'Warren', 1, 'Day', 4),
  (5, 'Harold', 'Smidt', 1, 'Day', 5),
  (6, 'Michael', 'McCormmak', 2, 'Day', 5),
  (7, 'Ernesto', 'Rodriguez', 1, 'Day', 6),
  (8, 'Gabriel', 'Zamora', 1, 'Day', 6),
  (9, 'Melissa', 'Parker', 2, 'Day', 7),
  (10, 'Diana', 'Munoz', 1, 'Swing', 7),
  (11, 'Sarah', 'Witherall', 1, 'Swing', 8),
  (12, 'Evelyne', 'Blakemore', 2, 'Swing', 8),
  (13, 'Loraine', 'Freeman', 1, 'Swing', 9),
  (14, 'Sharon', 'Smith', 1, 'Swing', 9),
  (15, 'Dennis', 'Peterson', 2, 'Swing', 10),
  (16, 'Daniel', 'Kaplan', 1, 'Swing', 10),
  (17, 'Maria', 'Lopez', 1, 'Swing', 11),
  (18, 'Jeanna', 'Piazza', 2, 'Swing', 11),
  (19, 'Beth', 'Kolko', 1, 'Swing', 12),
  (20, 'Cain', 'Gene', 1, 'Night', 12),
  (21, 'Chapman', 'Charlotte', 2, 'Night', 13),
  (22, 'Barrett', 'Lynda', 1, 'Night', 13),
  (23, 'Patton', 'Angie', 1, 'Night', 1),
  (24, 'Johnson', 'Maurice', 2, 'Night', 14),
  (25, 'Walton', 'Francis', 1, 'Night', 14),
  (26, 'Cook', 'Maureen', 1, 'Night', 15),
  (27, 'Terry', 'Monique', 2, 'Night', 15),
  (28, 'Wolfe', 'Chelsea', 1, 'Night', 2),
  (29, 'Kelly', 'Louise', 2, NULL, 2),
  (30, 'Vicki', 'Hoffman', 2, NULL, 3),
  (31, 'Ryan', 'Lamb', 2, NULL, 3),
  (32, 'Leticia', 'French', 2, NULL, 4),
  (33, 'Lauren', 'Carr', 2, NULL, 4),
  (34, 'Woodrow', 'Shaw', 2, NULL, 5),
  (35, 'Lois', 'Webster', 2, NULL, 5),
  (36, 'Sean', 'Ryan', 2, NULL, 6),
  (37, 'Vicky', 'Bowers', 2, NULL, 6),
  (38, 'Phillip', 'Peters', 2, NULL, 7),
  (39, 'Josephine', 'Nash', 2, NULL, 7);
...
(airman_id, qualification_id, earn_date, periodic_due, last_sat, currency_expiration)
VALUES
  (1, 1, '2019-01-25', '2019-01-25', '2019-01-25', '2019-01-25'),
  (2, 2, '2019-02-25', '2019-02-25', '2019-02-25', '2019-02-25'),
  (3, 3, '2019-03-25', '2019-03-25', '2019-03-25', '2019-03-25'),
  (4, 4, '2019-04-25', '2019-04-25', '2019-04-25', '2019-04-25'),
  (5, 5, '2019-05-25', '2019-05-25', '2019-05-25', '2019-05-25'),
  (6, 6, '2019-06-25', '2019-06-25', '2019-06-25', '2019-06-25'),
  (7, 7, '2019-07-25', '2019-07-25', '2019-07-25', '2019-07-25'),
  (8, 8, '2019-08-25', '2019-08-25', '2019-08-25', '2019-08-25'),
  (9, 9, '2019-09-25', '2019-09-25', '2019-09-25', '2019-09-25'),
  (10, 10, '2019-10-25', '2019-10-25', '2019-10-25', '2019-10-25'),
  (11, 11, '2019-01-25', '2019-01-25', '2019-01-25', '2019-01-25'),
  (12, 12, '2019-02-25', '2019-02-25', '2019-02-25', '2019-02-25'),
  (13, 13, '2019-03-25', '2019-03-25', '2019-03-25', '2019-03-25'),
  (14, 14, '2019-04-25', '2019-04-25', '2019-04-25', '2019-04-25'),
  (15, 1, '2019-05-25', '2019-05-25', '2019-05-25', '2019-05-25'),
  (16, 2, '2019-06-25', '2019-06-25', '2019-06-25', '2019-06-25'),
  (17, 3, '2019-07-25', '2019-07-25', '2019-07-25', '2019-07-25'),
  (18, 4, '2019-08-25', '2019-08-25', '2019-08-25', '2019-08-25'),
  (19, 5, '2019-09-25', '2019-09-25', '2019-09-25', '2019-09-25'),
  (20, 6, '2019-10-25', '2019-10-25', '2019-10-25', '2019-10-25'),
  (21, 7, '2019-11-25', '2019-11-25', '2019-11-25', '2019-11-25'),
  (22, 8, '2019-12-25', '2019-12-25', '2019-12-25', '2019-12-25'),
  (23, 9, '2019-12-25', '2019-12-25', '2019-12-25', '2019-12-25'),
  (24, 10, '2019-01-25', '2019-01-25', '2019-01-25', '2019-01-25'),
  (25, 11, '2019-02-25', '2019-02-25', '2019-02-25', '2019-02-25'),
  (26, 12, '2019-03-25', '2019-03-25', '2019-03-25', '2019-03-25'),
  (27, 13, '2019-04-25', '2019-04-25', '2019-04-25', '2019-04-25'),
  (28, 14, '2019-05-25', '2019-05-25', '2019-05-25', '2019-05-25'),
  (29, 8, '2019-06-25', '2019-06-25', '2019-06-25', '2019-06-25'),
  (30, 9, '2019-07-25', '2019-07-25', '2019-07-25', '2019-07-25'),
  (31, 10, '2019-08-25', '2019-08-25', '2019-08-25', '2019-08-25'),
  (32, 11, '2019-09-25', '2019-09-25', '2019-09-25', '2019-09-25'),
  (33, 12, '2019-10-25', '2019-10-25', '2019-10-25', '2019-10-25'),
  (34, 13, '2019-11-25', '2019-11-25', '2019-11-25', '2019-11-25'),
  (35, 14, '2019-12-25', '2019-12-25', '2019-12-25', '2019-12-25'),
  (36, 11, '2019-12-25', '2019-12-25', '2019-12-25', '2019-12-25'),
  (37, 12, '2019-01-25', '2019-01-25', '2019-01-25', '2019-01-25'),
  (38, 13, '2019-02-25', '2019-02-25', '2019-02-25', '2019-02-25'),
  (39, 14, '2019-03-25', '2019-02-25', '2019-03-25', '2019-02-25');
