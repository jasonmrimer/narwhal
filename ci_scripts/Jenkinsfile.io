node ('') {
    ...
    stage ('FortifyScan') {
        ...
        sh '/opt/hp_fortify_sca/bin/sourceanalyzer -64 -verbose -Xms2G -Xmx10G -b ${BUILD_NUMBER} "**/*" -exclude "client/node_modules/**/*" -exclude "client/build/**/*" -exclude "build/**/*" -exclude "acceptance/**/*" -exclude "client/src/stories/**/*" -exclude "client/storybook-static/**/*" -exclude "src/main/resources/static/**/*" -exclude "client/public/**/*"'
