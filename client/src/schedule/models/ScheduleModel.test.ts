...
describe('ScheduleModel', () => {
  ...
  it('should return if given day is on or off for panama a', () => {
    subject = new ScheduleModel(1, ScheduleType.PanamaA, true, true, false, false, true, true, true);
  ...
  it('should return if given day is on or off for panama a', () => {
    subject = new ScheduleModel(1, ScheduleType.PanamaB, false, false, true, true, false, false, false);
